...
st.set_page_config(page_title='Local Tamil LLM by VIDYASAGAR',
                   page_icon='💁🏻‍♂️',
                   layout='wide',
...
st.markdown('# :red[Local] 🏠 :red[Private] 🔒 :red[தமிழ் AI Assistant] 🤖', unsafe_allow_html=True)
